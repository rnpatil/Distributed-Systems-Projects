...
public class MeanMapCollective  extends Configured implements Tool {
	...
	void launch(int numOfDataPoints, int sizeOfVector, int numMapTasks, String workDir, String localDir)
		...
		runKMeansAllReduce(numOfDataPoints, sizeOfVector, numMapTasks, configuration, workDirPath,
				dataDir, outDir);
	...
	private void runKMeansAllReduce(int numOfDataPoints, int vectorSize, 
		...
		do {
			// ----------------------------------------------------------------------
			Job kmeansJob = configureKMeansJob(numOfDataPoints, vectorSize, numMapTasks,
